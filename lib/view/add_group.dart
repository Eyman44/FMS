...
void showEditGroupDialog(BuildContext context, int groupId) {
  final TextEditingController nameController = TextEditingController();
  final GroupEditController groupController = Get.put(GroupEditController(groupId: groupId));
  bool isPublic = false;
  File? selectedImage;
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  bool success = await groupController.updateGroup(
                    groupName,
                    isPublic,
                    selectedImage,
                  );
